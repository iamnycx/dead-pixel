  ...
  if (variant === "stroke") {
    return (
      ...
      >
        ...
        <rect x="19" y="3" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="5" y="5" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="3" y="3" width="2" height="2" rx="1" fill={primaryColor} />
        ...
        <rect x="3" y="19" width="2" height="2" rx="1" fill={primaryColor} />
