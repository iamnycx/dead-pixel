  ...
  if (variant === "stroke") {
    return (
      ...
      >
        ...
        <rect x="13" y="3" width="2" height="2" rx="1" fill={primaryColor} />
        ...
        <rect x="19" y="19" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="21" y="21" width="2" height="2" rx="1" fill={primaryColor} />
  ...
  if (variant === "duotone") {
    return (
      ...
      >
        ...
        <rect x="9" y="5" width="2" height="2" rx="1" fill={secondaryColor} />
        <rect x="11" y="5" width="2" height="2" rx="1" fill={secondaryColor} />
        <rect x="13" y="5" width="2" height="2" rx="1" fill={secondaryColor} />
        <rect x="3" y="7" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="3" y="9" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="3" y="11" width="2" height="2" rx="1" fill={primaryColor} />
        <rect x="3" y="13" width="2" height="2" rx="1" fill={primaryColor} />
        ...
        <rect x="11" y="7" width="2" height="2" rx="1" fill={secondaryColor} />
