...
export function SunIcon({ type = "stroke" }: IconProps) {
  if (type === "stroke") {
    return (
      <svg
        width="24"
      ...
      >
        ...
        <rect x="19" y="3" width="2" height="2" fill="#B7B7B7" />
        <rect x="5" y="5" width="2" height="2" fill="#B7B7B7" />
        <rect x="3" y="3" width="2" height="2" fill="#B7B7B7" />
        ...
        <rect x="3" y="19" width="2" height="2" fill="#B7B7B7" />
  ...
  if (type === "fill") {
    return (
      ...
      >
        <rect x="13" y="5" width="2" height="2" fill="#B7B7B7" />
        <rect x="7" y="7" width="2" height="2" fill="#B7B7B7" />
        <rect x="9" y="7" width="2" height="2" fill="#B7B7B7" />
        ...
        <rect x="9" y="9" width="2" height="2" fill="#B7B7B7" />
        ...
        <rect x="9" y="11" width="2" height="2" fill="#B7B7B7" />
